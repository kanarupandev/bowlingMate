# wellBowled Backend - Triggered CI/CD
import os
import shutil
import uuid
...
logger = logging.getLogger("wellBowled")
...
@app.get("/")
def health_check():
    return {"status": "ok", "service": "wellBowled-backend", "model": settings.GEMINI_MODEL_NAME}
...
async def test_overlay_stream(video_url: str = None):
    ...
    async def step_generator():
        ...
        try:
            ...
            base_url = "https://wellbowled-506790672773.us-central1.run.app"
...
async def upload_clip(
    ...
    try:
        ...
        base_url = str(settings.BASE_URL) if hasattr(settings, 'BASE_URL') else "https://wellbowled-506790672773.us-central1.run.app"
